...
export function TooltipIcon({ icon, name, description }: TooltipIconProps) {
  ...
  return (
    <div className="group/tip relative inline-flex">
      ...
      >
        <span className="grid h-5 w-auto shrink-0 place-items-center" aria-hidden>
          {icon}
        </span>
