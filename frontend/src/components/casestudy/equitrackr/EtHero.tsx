// frontend/src/components/casestudy/equitrackr/EtHero.tsx
import Link from 'next/link'
import { ArrowRight, ArrowLeft } from 'lucide-react'
import { EtConsolePreview } from './EtConsolePreview'

const META = [
  { k: 'Role', v: 'Product & systems design' },
  { k: 'Surface', v: 'Web platform' },
  { k: 'Scope', v: 'Multi-department' },
  { k: 'Stack', v: 'Next.js · TS · Postgres · Prisma' },
]

export function EtHero() {
  return (
        ...
        <div className="mt-6 grid grid-cols-1 items-center gap-14 lg:grid-cols-[1.05fr_1fr]">
          <div>
            <span className="anim-rise inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-ink-soft ghair">
              ...
              Healthcare Systems · Operational Platform
            </span>
            ...
            <h1 className="anim-rise mt-5 font-display text-[2.5rem] font-extrabold leading-[1.06] text-ink sm:text-[3rem] lg:text-[3.4rem]" style={{ animationDelay: '60ms' }}>
              ...
              <br />
              <span className="grad-plum-text">coordination, orchestrated.</span>
            </h1>

            <p className="anim-rise mt-5 max-w-[42ch] text-[1.08rem] leading-relaxed text-ink-soft" style={{ animationDelay: '120ms' }}>
              A healthcare equipment workflow platform — track, request, clean, and maintain mobile
              clinical assets across departments, with one operational registry underneath.
            </p>
