// frontend/src/components/casestudy/equitrackr/EtClose.tsx
import Link from 'next/link'
import { ArrowRight, ArrowLeft } from 'lucide-react'

export function EtClose() {
  return (
      ...
      >
        <div>
          ...
          <p className="mt-2 max-w-md text-sm leading-relaxed text-ink-soft">
            Happy to talk through the lifecycle engine, the role-based surfaces, and how new asset
            classes get added.
          </p>
        </div>
