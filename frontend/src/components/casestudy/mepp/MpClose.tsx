// frontend/src/components/casestudy/mepp/MpClose.tsx
      ...
      >
        <div>
          ...
          <p className="mt-2 max-w-md text-sm leading-relaxed text-ink-soft">
            Happy to walk through the RLS policies, the blind-index derivation, or why the vendor projection is a
            separate read path rather than a filter.
          </p>
        </div>
