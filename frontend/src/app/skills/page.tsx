...
/**
 * Retired route. `/skills` belonged to an older design generation; the skills
 * content now lives on `/about`.
 *
...
export const metadata: Metadata = {
  ...
  description: 'This page has moved. Skills and expertise now live on /about.',
  alternates: { canonical: '/about' },
  robots: { index: false, follow: true },
}

export default function SkillsBridgePage() {
  return (
