...
/**
 * Retired route. `/education` belonged to an older design generation; education
 * and certifications now live on `/about`.
 *
...
export const metadata: Metadata = {
  ...
  description: 'This page has moved. Education and certifications now live on /about.',
